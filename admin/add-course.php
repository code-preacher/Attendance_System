...
$lib->check_login2();
$lec=$crud->displayAllWithOrder('lecturer','id','desc');
?>
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <select class="form-control" required="required" name="lecturer">
                                      <option value="">--Select Lecturer--</option>
                                      <?php foreach ($lec as $k) { ?>
                                    ...
                                    <?php  } ?>
                                        ...
                                        <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Course Name :</p>
                                            <input type="text" class="form-control input-rounded" name="name" placeholder="Please Course Name" required="required">
                                        </div>
                                          <div class="form-group">
                                            <p class="text-muted m-b-15 f-s-12">Course Code :</p>
                                            <input type="text" class="form-control input-rounded" name="code" placeholder="Please Course Code" required="required">
                                        </div>
