...
if(isset($_GET['delete'])){
    $crud->emptyTable('attendance','view.php');
}
            ...
            <div class="col-lg-12">
                ...
                <div class="row page-titles">
                   ...
                   <div class="container-fluid">
                    ...
                    <!-- /# column -->
                    <div class="col-lg-12">
                        <div class="card">  <p><strong><?php $lib->msg2(); ?></strong></p>
                            <div class="card-title">
                                <h4>ALL ATTENDANCE 

                                    <a href="view.php?delete=is_a_goal"><button class="btn btn-danger btn-group-right"><i class="ti-trash">Empty table</i></button></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                      ...
                                      $qt=$crud->displayAllWithOrder('attendance','id','desc');
                                      $c=1;
                                      if ($qt) {

                                       foreach($qt as $f){
                                        $qr=$crud->displayByCourse('course',$f['course_code']);
                                    ...
                                    echo "<tr><td colspan='6'><center>No User at the moment</center</td></tr>";
                                }
