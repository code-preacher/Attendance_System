...
<body class="fix-header fix-sidebar">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">View All Course</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-title">
                                <h4>ALL COURSE
                                    <a href="add-course.php"><button class="btn btn-primary btn-group-right"><i class="ti-plus">Add Course</i></button></a>
    ...
    ?>
                                            <tr>
                                                 <td><?php echo $c++;?></td>
                                                <td><?php echo strtoupper($crud->displayByName2('lecturer',$f['lecturer_id']));?></td>
                                                <td><?php echo $f['name'];?></td>
                                                <td><?php echo $f['code'];?></td>
                                                <td><?php echo $f['date'];?></td>
                                                <td><a href="view-course.php?id=<?php echo $f['id']; ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i></a></td>
