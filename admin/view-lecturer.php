...
$lib->check_login2();
if(isset($_GET['id'])){
$crud->delete($_GET['id'],'lecturer','view-lecturer.php');
}
...
<body class="fix-header fix-sidebar">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">View All Lecturer</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-title">
                                <h4>ALL LECTURER
                                    <a href="add-lecturer.php"><button class="btn btn-primary btn-group-right"><i class="ti-plus">Add Lecturer</i></button></a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
     <?php
     $qt=$crud->displayAllWithOrder('lecturer','id','desc');
    $c=1;
    if ($qt) {
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><a href="view-detail.php?id=<?php echo $f['id']; ?>"><i class="fa fa-eye"></i></a>|<a href="view-lecturer.php?id=<?php echo $f['id']; ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i></a></td>
