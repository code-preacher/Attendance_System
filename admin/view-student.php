...
<body class="fix-header fix-sidebar">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-title">
                                <h4>ALL STUDENT
                                    <a href="add-student.php"><button class="btn btn-primary btn-group-right"><i class="ti-plus">Add Student</i></button></a>
                                    <a href="view-allocation.php"><button class="btn btn-primary btn-group-right"><i class="ti-plus">Allocate Course</i></button></a>
    ...
    ?>
                                            <tr>
                                                ...
                                                <td><a href="view-detail2.php?id=<?php echo $f['id']; ?>"><i class="fa fa-eye"></i></a>|<a href="view-student.php?id=<?php echo $f['id']; ?>" onClick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i></a></td>
