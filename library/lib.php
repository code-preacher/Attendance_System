...
class Lib
{
	...
	public function check_login2()
	{
		if($_SESSION['login']=="")
		{	
			$this->redirect2('../index.php?msg=You must login to access requested page!&type=error');
		}
	}
	...
	public function logout()
	{
		...
		$_SESSION['id'] = "";
		session_unset();	
		$this->redirect2('../index.php?msg=You have successfully logged out&type=success');
	}
