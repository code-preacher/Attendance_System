...
<body class="fix-header fix-sidebar">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                         ...
                         <li class="breadcrumb-item"><a href="view-process.php">Back to Process</i></a></li>
    ...
    if ($qt) {
     ...
     foreach($qt as $f){
        ...
        $student=$crud->displayOne('student',$f['matno']);
    ?>
                                            <tr>
                                                 <td><?php echo $c++;?></td>
                                                ...
                                                <td><?php echo 'BSU/SC/CMP/15/'.$f['matno'];?></td>
                                                     ...
                                                     <td>
                                                        ...
                                                        if ($cx >= $_GET['countVal']) {
                                                          ...
                                                          $crud->sendMessage($student['g_name'],$student['g_no'],$student['name']);
