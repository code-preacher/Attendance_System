...
<body class="fix-header fix-sidebar">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">View My Course Student</a></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
     <?php
     $qt=$crud->displayAllSpecificCourse('course_allocation',$_GET['id']);
    $c=1;
    if ($qt) {
   ...
   foreach($qt as $f){
    ...
    echo "<tr><td colspan='3'><center>No Student at the moment</center</td></tr>";
    }
    ?>
                                        </tbody>
                                    </table>
