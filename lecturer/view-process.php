            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Process Attendance</a></li>
   ...
   foreach($qt as $f){
    ...
    ?>
                                            <tr>
                                                 ...
                                                 <td><a href="process.php?id=<?=$f['id'];?>"><i class="fa fa-refresh"></i></a></td>
